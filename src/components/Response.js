...
//export default used to check response in object
export default {
  ...
  searchInformation: {
    ...
    totalResults: "6550000000",
    formattedTotalResults: "6,550,000,000",
  },
  items: [
    {
    ...
    },
    {
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTsedxpW7zILLVnnY38x6zRNpFHQSvldqdnaqOWKug3CsrRnEkUEB3e2vo",
            width: "433",
            height: "116",
          },
        ],
